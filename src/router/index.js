...
const routes = [
  ...
  { path: '/pages/Academic-Register.html', name: 'AcademicRegister', component: () => import('../views/LegacyContentView.vue'), meta: { page: { title: 'Academic Registration', intro: 'Register your interest in IGGAARL academic programmes.' } } },
